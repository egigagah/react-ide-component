...
const IdeComponent = ({ datas }) => {
  ...
  const mappingDatas = (d) => {
    return new Promise((resolve, reject) => {
      try {
        ...
        arr.forEach((c, i) => {
          arr[i] = hljs__default["default"].highlight(c, {
            language: d.lang,
          }).value;
        });
        d.contentData = arr;
  ...
  return React__default["default"].createElement(
    "div",
    { id: "cstm-editor", className: "ide-component" },
    React__default["default"].createElement(
      "div",
      { id: "bar-editor", className: "bar-ide-component" },
      datas.map((item, idx) => {
        var _a;
        return React__default["default"].createElement(
          "button",
          {
            id:
              (_a = item === null || item === void 0 ? void 0 : item.id) !==
                null && _a !== void 0
                ? _a
                : `${
            ...
            key: `${
              item === null || item === void 0 ? void 0 : item.filename
            }-${item === null || item === void 0 ? void 0 : item.id}-${idx}`,
            onClick: () => {
            ...
            className: `tab-bar ${
              (tabActive === null || tabActive === void 0
                ? void 0
    ...
    React__default["default"].createElement(
      "div",
      { id: "body-editor", className: "body-editor" },
      React__default["default"].createElement(
        "div",
        { className: "content-editor" },
        React__default["default"].createElement(
          "div",
          { className: "body-number-wrapper" },
          !tabLoading &&
            ((_a =
              tabActive === null || tabActive === void 0
                ? void 0
                : tabActive.contentData) === null || _a === void 0
              ? void 0
              : _a.map((item, idx) =>
                  React__default["default"].createElement(
                    "div",
        ...
        React__default["default"].createElement(
          ...
          !tabLoading &&
            ((_b =
              tabActive === null || tabActive === void 0
                ? void 0
                : tabActive.contentData) === null || _b === void 0
              ? void 0
              : _b.map((item, idx) =>
                  React__default["default"].createElement(
                    "div",
                    ...
                    React__default["default"].createElement(
                      ...
                      React__default["default"].createElement(
                        ...
                        parse__default["default"](item === "" ? " " : item)
                      )
                    )
                  )
                ))
