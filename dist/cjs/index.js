...
const IdeComponent = ({ datas }) => {
    ...
    const typewritingCode = () => {
        ...
        gsap__default["default"].utils.toArray(".codeScript-writter").forEach((el) => {
    ...
    return (React__default["default"].createElement("div", { id: "cstm-editor", className: "ide-component" },
