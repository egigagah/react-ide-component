...
const IdeComponent = ({ datas }) => {
    ...
    const typewritingCode = () => {
        ...
        gsap.utils.toArray('.codeScript-writter')
            .forEach(el => {
    ...
    return (React.createElement(Fragment, null,
        React.createElement("div", { id: "cstm-editor", className: "ide-component" },
            React.createElement("div", { id: "bar-editor", className: "bar-ide-component" }, datas.map((item, idx) => (React.createElement("button", { key: idx, onClick: () => {
            ...
            React.createElement("div", { id: "body-editor", className: "body-editor" },
                React.createElement("div", { className: "content-editor" },
                    React.createElement("div", { className: "body-number-wrapper" }, !tabLoading && ((_a = tabActive === null || tabActive === void 0 ? void 0 : tabActive.contentData) === null || _a === void 0 ? void 0 : _a.map((item, idx) => (React.createElement("div", { key: `num-${tabActive.id}-${idx}`, id: "number-body", className: "number-content-editor" },
                        React.createElement("span", null, idx + 1)))))),
                    React.createElement("div", { className: "body-text-wrapper" }, !tabLoading && ((_b = tabActive === null || tabActive === void 0 ? void 0 : tabActive.contentData) === null || _b === void 0 ? void 0 : _b.map((item, idx) => (React.createElement("div", { key: `text-${tabActive.id}-${idx}`, id: "text-body", className: "text-content-editor" },
                        React.createElement("pre", { style: { padding: '0px !important', background: 'transparent !important' } },
                            React.createElement("code", { style: { padding: '0px !important', background: 'transparent !important' }, className: "codeScript-writter" }, parse(item == '' ? ' ' : item)))))))))))));
};
